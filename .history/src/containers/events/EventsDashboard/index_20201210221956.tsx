...
const EventsDashboard: React.FC<Props> = (props: Props) => {
	...
	return (
		<tr>
			...
			{<EventCom event={date: "2019-23-04"eventType: "meeting"fromTime: "2019-23-04 10:21:45"id: "5fcde8138a1de3f2f24b42fc"title: "laboris irure tempor" toTime: "2019-23-04 17:09:02"} />}
		</tr>
	);
};

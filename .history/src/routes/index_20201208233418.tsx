...
export default (
	<App>
		<Switch>
			<Route exact path={RoutesPath.ROOT} component={EventsPage} />
			<Route exact path={RoutesPath.FORM_EXAMPLE} step={StepTypes.DEVICE_GALLERY.name} component={DeviceGalleryPage} />
